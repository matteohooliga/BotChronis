...
## 🕒 **Chronis – Bot RP de gestion des temps de service**

Chronis est un bot Discord conçu pour les communautés RP souhaitant gérer facilement et automatiquement le temps de service de leurs joueurs.
Il offre une interface rapide, claire et fiable pour suivre l’activité d’une faction ou d’une organisation.
...
## 🕒 **Chronis – RP Service Time Management Bot**

Chronis is a Discord bot built for RP communities that need a clean, automated, and reliable way to track their players' service time.
It provides an efficient system to monitor the activity of any RP faction or organization.
